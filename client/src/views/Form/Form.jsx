  ...
  return (
    <div className={styles.formPage}>
      ...
      <div className={styles.formContainer}>
        ...
        {errors.name && (
          <span className={styles.errorAlert}>{errors.name}</span>
        )}
        {errors.difficulty && (
          <span className={styles.errorAlert}>{errors.difficulty}</span>
        )}
        {errors.duration && (
          <span className={styles.errorAlert}>{errors.duration}</span>
        )}
        {errors.season && (
          <span className={styles.errorAlert}>{errors.season}</span>
        )}
